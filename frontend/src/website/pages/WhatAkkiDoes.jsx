  ...
  return (
    ...
    >
      <section className="website-section">
        ...
        <p style={{ maxWidth: "60ch", marginBottom: 36, fontSize: 18, color: "#6B6B6B" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 18 }}>
          {SURFACES.map((s) => (
            <div key={s.id} className="website-tile" data-testid={`surface-tile-${s.id}`}>
              ...
              <p style={{ fontSize: 15, color: "#2A1B1D" }}>{s.body}</p>
              <p style={{ fontSize: 13, color: "#6B6B6B", fontStyle: "italic", margin: 0, marginTop: 12 }}>
