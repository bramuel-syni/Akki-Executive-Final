...
export const TERMS = {
  ...
  blocks: [
    ...
    { h: "What we provide", p: "A private working environment for senior people to use AI. The service is provided as-is, on a subscription basis arranged during the founding-cohort intake." },
