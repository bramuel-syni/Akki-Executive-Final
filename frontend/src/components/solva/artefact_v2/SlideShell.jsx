/**
 * Solva v2 — SlideShell (Slice 2a, 2026-05-29).
 *
...
export default function SlideShell({
  ...
  return (
    <section
      ...
      className="solva-v2-slide relative bg-white border border-[var(--rule)] rounded-sm px-10 py-12 mb-6 print:mb-0 print:break-after-page print:rounded-none print:border-0"
      style={{ minHeight: "660px" }}
    >
      {/* Header strip — slide number + section tag */}
      <header className="flex items-baseline justify-between mb-8">
        <span
          className="font-mono text-[10.5px] uppercase tracking-[0.18em] text-[var(--muted)]"
      ...
      {/* Slide body */}
      <div className="solva-v2-slide-body">{children}</div>
