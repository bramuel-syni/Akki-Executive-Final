...
const DialogContent = React.forwardRef(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // Patch 28E — global modal sizing rule.
        //   max-h-[85vh] + overflow-y-auto so content scrolls
        //   internally rather than clipping on shorter viewports.
        //   pb-2 in addition to p-6 so the last action row never
