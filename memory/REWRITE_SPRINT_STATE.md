...
| E | Solva Phases 2-4 (Tension / Guardrails / Polish) | **complete** (2026-05-16) | 0 open. 8 sub-tasks delivered: Phase D UI wiring (A), guardrail ladder for parity (B), tension auto-activation (C), admin observability dashboard (D), Trust-verified CTA (E), legacy soft-archive migration (F), Solva→Work Studio export (G), chat privacy-report PDF (H). 620 pytest passing. | `sprints/PHASE_E_CLOSEOUT.md` |
| F | Engine real signals | **queued (next)** | — | — |
