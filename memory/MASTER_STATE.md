...
**Total items across 3 QA docs: 37. ✅ 29 · 🟡 0 · ❌ 6 · 🚧 2 · ❔ 0.** (Plus Bug #30 ✅.)
...
- Phase B5 (Document workflow + Calendar polish): G6 (Notes autosave full spec) + G7 (Send Share Field-required error) + G10 (Calendar text in fig 32 to be removed) → 🟡 IN PROGRESS (2/3 done) — **G6 ✅ tester-verified 5/5 2026-06-04**. **G7 ✅ tester-verified 4/4 2026-06-04**. G10 NOT STARTED — final B5 dispatch. Memos: `sprints/TRACK_B_PHASE_B5_G6_NOTES_AUTOSAVE.md`, `sprints/TRACK_B_PHASE_B5_G7_SEND_SHARE_VALIDATION.md`.
